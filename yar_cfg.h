...
#define YARMICO_PROJECT_CODE_STRING "YARMICO2"
#define YARMICO_PROJECT_TITLE_STRING "YARMICO2"
#define YARMICO_PROJECT_DATE_STRING "2022-DEC-11"

#define YARMICO_USE_TILEMAP TRUE
#define YARMICO_TILEMAP_MAX_MAPS 1
